<div class="modalContainer">
    <div class="modalBody">
        ...
        <a onclick="redirectToPage('?message=thankyou');" download="<?php echo $file['name']; ?>" href="<?php echo $file['path']; ?>" id="linkToCopy"><i class="fas fa-download"></i> <?php echo $name . '.' . $file['ext'] . ' (' . $size . ')'; ?></span></a>
    </div>
</div>
