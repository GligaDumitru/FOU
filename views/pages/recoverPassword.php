...
?>
  <head>
    ...
    <link
      rel="icon"
      href="https://cdn.pixabay.com/photo/2016/01/03/00/43/upload-1118929_960_720.png"
    />
  </head>
    ...
    <header class="app mainHeader">
      ...
      <div class="row">
        <div class="col center">
          <form action="/FOU/?controller=auth&action=recoverPassword" method = "POST" class="loginform">
            ...
            <div class="group-items">
              <button type="submit" class="app button submitLogin">
                Reseteaza parola
              </button>
            </div>
          </form>
